...
<div class="col-md-12">
        ...
        <h3>Histórico pagamento associado:<a href="{!! '/associados/'.$associado->id !!}">{!! $associado->nome_completo !!}</a> | Admissão: {{\Carbon\Carbon::parse($associado->admissao)->format('d/m/y')}}</h3>
