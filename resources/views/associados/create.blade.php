...
@section('content')
    ...
    <div class="card-header bg-dark">
        <h1 class="text-light">Cadastrar Associado</h1>

        <div class="card-body">
            <form novalidate action="{{route('associados.store')}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="jumbotron">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4"> <!-- Matrícula Antiga -->
                            ...
                            <input type="text" class="form-control" id="matricula_antiga" name="matricula_antiga"
                                   placeholder="Matrícula Antiga"
                        ...
                        <div class="form-group col-md-4"> <!-- Matrícula Nova -->
                            ...
                            <input type="text" class="form-control" id="matricula_nova" name="matricula_nova"
                                   placeholder="Matrícula Nova"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4"> <!-- Admissão -->
                            ...
                            <input type="text" class="form-control" id="admissao" name="admissao"
